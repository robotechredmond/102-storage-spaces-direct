# Create a Storage Spaces Direct (S2D) Information Worker (IW) File Server Cluster with Windows Server 2016 on an existing VNET
This template will create a Storage Spaces Direct (S2D) IW File Server cluster using Windows Server 2016 in an existing VNET and Active Directory environment.
...
+	A Windows Server 2016 cluster for storage nodes, provisioned for Storage Spaces Direct (S2D) and the IW File Server role
...
<a href="https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Frobotechredmond%2F102-storage-spaces-direct%2Fmaster%2Fazuredeploy.json" target="_blank">
    <img src="http://azuredeploy.net/deploybutton.png"/>
</a>
<a href="http://armviz.io/#/?load=https%3A%2F%2Fraw.githubusercontent.com%2Frobotechredmond%2F102-storage-spaces-direct%2Fmaster%2Fazuredeploy.json" target="_blank">
